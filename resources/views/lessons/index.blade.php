                        ...
                        <form class="pt-3 add-lesson-form" id="create-form" action="{{ route('lesson.store') }}"
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <select name="class_section_id" class="lessons_class_section_id form-control"> 
                                        <option value="">--{{ __('select') }}--</option>
                                        @foreach ($unique_class_sections as $option)
                                            <option value="{{ $option->id }}" data-class="{{ $option->class_id }}">
                                                {{ $option->name }}
                                            </option>
                                        @endforeach
                                    </select>
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-2 form-group text-nowrap">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="class_section_name" data-sortable="true">
                                        {{ __('class_section') }}</th>
                                    <th scope="col" data-field="semester_name" data-sortable="true">
                                        {{ __('semester') }}</th>

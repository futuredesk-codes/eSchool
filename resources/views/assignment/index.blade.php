                        ...
                        <form class="pt-3 add-assignment-form" id="create-form" action="{{ route('assignment.store') }}"
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <select name="session_year" id="session_year" data-scope="table"
                                        class="form-control session_year assignment_session_year">
                                        @foreach ($session_years as $session_year)
                                            <option value="{{ $session_year->id }}"
                                                {{ $session_year->id == $current_session_year_id ? 'selected' : '' }}>
                                                {{ $session_year->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <select name="class_section_id_in_assignment" id="class_section_id_in_assignment"
                                        class="class_section_id_in_assignment form-control">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-6" id="extra_days_for_resubmission_div"
                                    style="display: none;">
                                    <label>{{ __('extra_days_for_resubmission') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="extra_days_for_resubmission"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="toolbar">
                            <div class="row">
                                <div class="col">
                                    <label for="filter_class_section_id" class="form-label text-nowrap">
                                        {{ __('class_section') }}
                                    </label>
                                ...
                                <div class="col">
                                    ...
                                    <select name="filter_session_year" id="filter_session_year" data-scope="table"
                                        class="form-control filter_session_year assignment_filter_session_year">
                                        @foreach ($session_years as $session_year)
                                            <option value="{{ $session_year->id }}"
                                                {{ $session_year->id == $current_session_year_id ? 'selected' : '' }}>
                                                {{ $session_year->name }}
                                ...
                                <div class="col">
                                    <label for="filter_subject_id" class="form-label text-nowrap">
                                        {{ __('subject') }}
                                    </label>
                        ...
                        <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="points">{{ __('points') }}</th>
                                    ...
                                    <th scope="col" data-field="session_year_id" data-visible="false">
                                        {{ __('session_year_id') }}</th>
                                    <th scope="col" data-field="created_at" data-visible="false">
                                        {{ __('created_at') }}</th>
                                    <th scope="col" data-field="updated_at" data-visible="false">
                                        {{ __('updated_at') }}</th>
                        ...
                        <form class="pt-3 edit-assignment-form" id="edit-form" action="{{ url('assignment') }}"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-4">
                                        ...
                                        <select name="class_section_id" id="edit_class_section_id"
                                            class="class_section_id form-control" disabled>
                                            <option value="">--{{ __('select_class_section') }}--</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12 col-md-4">
                                        <label>{{ __('subject') }} <span class="text-danger">*</span></label>
                                        <select name="subject_id" id="edit_subject_id" class="subject_id form-control" disabled>
                                            <option value="">--{{ __('select_subject') }}--</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6" id="edit_extra_days_for_resubmission_div"
                                        style="display: none;">
                                        <label>{{ __('extra_days_for_resubmission') }} <span
                                                class="text-danger">*</span></label>

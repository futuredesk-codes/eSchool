    ...
    <div class="content-wrapper">
        ...
        <div class="row grid-margin">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form class="pt-3" id="create-online-exam-questions-form" method="POST"
                            ...
                            <div class="bg-light p-4 rounded">
                                ...
                                <div id="equation-question" style="display: none">
                                    ...
                                    <div class="add_button_equations mb-4">
                                        <button class="btn btn-dark btn-sm" type="button" id="add-new-eqation-option">
                    ...
                    <div class="card-body">
                        ...
                        <div id="toolbar" class="row">
                            ...
                            <div class="form-group ml-4">
                                ...
                                <select name="class_id" id="filter-view-question-class-id" class="form-control"
                                    style="width:100%;" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="form-group ml-4">
                                ...
                                <select name="subject_id" id="filter-question-subject-id" class="form-control"
                                    style="width:100%;" tabindex="-1" aria-hidden="true">
                                    <option value="">{{ __('all') }}</option>
                        ...
                        <table aria-describedby="mydesc" class='table' data-escape="false" id='table_list_questions'
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="options" data-sortable="false"
                                    ...
                                    <th scope="col" data-field="operate" data-escape="false" data-sortable="false"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        {{ __('edit') . ' ' . __('online') . ' ' . __('exam') . ' ' . __('question') }}</h5>
                ...
                <form id="edit-question-form" class="pt-3" action="{{ url('online-exam-question') }}">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>{{ __('class') }} <span class="text-danger">*</span></label>
                                <select required name="edit_class_id" id="edit-online-exam-class-id"
                                    class="form-control select2 online-exam-class-id" style="width:100%;" tabindex="-1"
                                    aria-hidden="true">
                                    <option value="">--- {{ __('select') . ' ' . __('class') }} ---</option>
                                    @foreach ($classes as $class)
                                        <option value="{{ $class->id }}">
                            ...
                            <div class="form-group col-md-6">
                                <label>{{ __('subject') }} <span class="text-danger">*</span></label>
                                <select required name="edit_subject_id" id="edit-online-exam-subject-id"
                        ...
                        <div id="edit-simple-question" class="bg-light p-3" style="display: none">
                            <div class="form-group">
                                <label>{{ __('question') }} <span class="text-danger">*</span></label>
                                {!! Form::textarea('edit_question', null, [
                                    'placeholder' => __('enter') . ' ' . __('question'),
                                    'class' => 'form-control edit-question',
                                    'rows' => 4,
                                ]) !!}
                            </div>
                            ...
                            <div class="add_button">
                                <button class="btn btn-dark btn-sm add-new-edit-option" type="button"><i
                        ...
                        <div id="edit-equation-question" class="bg-light p-3" style="display: none">
                            ...
                            <div class="add_button_equations p-4">
                                <button class="btn btn-dark btn-sm add-new-edit-eoption" type="button"><i
                                        class="fa fa-plus-circle fa-3x mr-2"
                                        aria-hidden="true"></i>{{ __('add_option') }}</button>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="form-group col-md-6 mt-2">
                                <div class="form-group">
                                    <label>{{ __('answer') }} <span class="text-danger">*</span></label>
                                    <select multiple required name="edit_answer[]"
                                        class="edit_answer_select form-control js-example-basic-single select2-hidden-accessible"
                                        style="width:100%;" tabindex="-1" aria-hidden="true">
                                    </select>
                                </div>

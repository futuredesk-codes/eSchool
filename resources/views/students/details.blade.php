...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table table-responsive' id='table_list'
                                    data-toggle="table" data-url="{{ url('students-list-data') }}"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="user_id" data-visible="false">
                                                {{ __('user_id') }}</th>
                                            ...
                                            <th scope="col" data-field="blood_group" data-visible="false">
                                                {{ __('blood_group') }}</th>
                                            ...
                                            <th scope="col" data-field="stream_name" data-visible="false">
                                                {{ __('stream') }}</th>
                                            <th scope="col" data-field="category_id" data-visible="false">
                                                {{ __('category') . ' ' . __('id') }}</th>
                                            <th scope="col" data-field="category_name" data-visible="false">
                                                {{ __('category') }}</th>
                                            <th scope="col" data-field="caste" data-visible="false">{{ __('caste') }}
                                            </th>
                                            <th scope="col" data-field="religion" data-visible="false">
                                                {{ __('religion') }}</th>
                                            <th scope="col" data-field="admission_date">{{ __('admission_date') }}</th>
                                            <th scope="col" data-field="height" data-visible="false">{{ __('height') }}
                                            </th>
                                            <th scope="col" data-field="weight" data-visible="false">
                                                {{ __('weight') }}</th>
                                            <th scope="col" data-field="father_full_name">
                                                {{ __('father') . ' ' . __('name') }}</th>
                                            <th scope="col" data-field="father_mobile">
                                                {{ __('father') . ' ' . __('mobile') }}</th>
                                            <th scope="col" data-field="father_occupation" data-visible="false">
                                                {{ __('father') . ' ' . __('occupation') }}</th>
                                            <th scope="col" data-field="father_image"
                                                data-formatter="fatherImageFormatter">
                                                {{ __('father') . ' ' . __('image') }}</th>
                                            <th scope="col" data-field="mother_full_name">
                                                {{ __('mother') . ' ' . __('name') }}</th>
                                            <th scope="col" data-field="mother_occupation" data-visible="false">
                                                {{ __('parents') . ' ' . __('occupation') }}</th>
                                            <th scope="col" data-field="mother_image"
                                                data-formatter="motherImageFormatter">
                                                {{ __('mother') . ' ' . __('image') }}</th>
                                            <th scope="col" data-field="guardian_full_name">
                                                {{ __('guardian') . ' ' . __('name') }}</th>
                                            <th scope="col" data-field="guardian_mobile">
                                                {{ __('guardian') . ' ' . __('mobile') }}</th>
                                            <th scope="col" data-field="guardian_occupation" data-visible="false">
                                                {{ __('guardian') . ' ' . __('occupation') }}</th>
                                            <th scope="col" data-field="guardian_image"
                                                data-formatter="guardianImageFormatter">
                                                {{ __('guardian') . ' ' . __('image') }}</th>
                                            <th scope="col" data-field="is_new_admission" data-visible="false">
                                                {{ __('is_new_admission') }}</th>

                                            @canany(['student-edit', 'student-delete', 'generate-document'])
                                                <th data-escape="false" data-events="studentEvents" data-width="150"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                <div class="d-flex">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" name="edit_parent_guardian_type" value="parent"
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" name="edit_parent_guardian_type" value="guardian"
                                                class="form-check-input"
    ...
    <input type="hidden" id="is_restricted_teacher" value="{{ $is_restricted_teacher ? '1' : '0' }}">
    <input type="hidden" id="student_class_sections_url" value="{{ url('student-class-sections') }}">
@endsection

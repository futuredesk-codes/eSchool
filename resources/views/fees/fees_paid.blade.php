...
<div class="content-wrapper">
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div id="toolbar" class="row">
                        <div class="col">
                            <label for="filter_session_year" style="font-size: 0.89rem">
                                {{ __('session_years') }}
                            </label>
                    ...
                    <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                        ...
                        data-query-params="feesPaidListQueryParams">
                        <thead>
                            <tr>
                                <th scope="col" data-field="id" data-sortable="true" data-visible="false">
                                    {{ __('id') }}
                                </th>
                                <th scope="col" data-field="student_id" data-sortable="false" data-visible="false">
                                    {{ __('student_id') }}
                                </th>
                                ...
                                <th scope="col" data-field="stream_name" data-sortable="false">{{ __('stream') }}
                                </th>

                                <th scope="col" data-field="total_fees" data-formatter="amountFormatter"
                                    data-sortable="false" data-align="center">
                                    {{ __('total') }} {{ __('fees') }}
                                </th>
                                <th scope="col" data-field="fees_status" data-sortable="false"
                                    data-formatter="feesPaidStatusFormatter" data-align="center">{{ __('fees') }}
                                    {{ __('status') }}
                                </th>
                                <th scope="col" data-field="date" data-sortable="false" data-align="center">
                                    {{ __('date') }}
                                </th>
                                <th scope="col" data-field="session_year_name" data-sortable="false"
                                    data-align="center">{{ __('session_years') }}</th>
        ...
        <div class="modal fade" id="compulsoryModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-m" role="document">
                <div class="modal-content">
                    ...
                    <form class="pt-3 pay_compulsory_fees_offline form-validation" method="post"
                        ...
                        <input type="hidden" name="session_year_id" id="compulsory_session_year_id" value="" />
                        ...
                        <div class="modal-body">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="mode"
                                                    class="cash_compulsory_mode  mode" value="0" checked>
                                                {{ __('cash') }}
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="mode"
                                                    class="cheque_compulsory_mode mode" value="1">
                                                {{ __('cheque') }}
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group cheque_no_container" style="display: none">
                                ...
                                <input type="number" name="cheque_no" placeholder="{{ __('cheque_no') }}"
        ...
        <!--Optional Fees Modal -->
        <div class="modal fade" id="optionalModal" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-m" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form class="pt-3 pay_optional_fees_offline form-validation" method="post"
                        ...
                        <input type="hidden" name="session_year_id" id="optional_session_year_id" value="" />
                        <h4 class="ml-4">
                            <span class="student_name"></span>
                        </h4>
                        <div class="modal-body">
                            ...
                            <div class="row mode_container">
                                <div class="form-group col-sm-12 col-md-12">
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="mode" class="mode cash_mode"
                                                    value="0" checked>
                                                {{ __('cash') }}
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="mode" class="mode cheque_mode"
                                                    value="1">
                                                {{ __('cheque') }}
                                            </label>
                                        </div>

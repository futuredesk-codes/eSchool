                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="total_fees" data-sortable="false"
                                        data-formatter="amountFormatter" data-align="center">
                                        {{ __('total') }} {{ __('fees') }}</th>
                                    <th scope="col" data-field="mode" data-sortable="false"
                                        data-align="center"data-formatter="feesPaidModeFormatter">{{ __('mode') }}</th>
                                    <th scope="col" data-field="cheque_no" data-sortable="false" data-align="center">
                                        {{ __('cheque_no') }}</th>
                                    <th scope="col" data-field="payment_gateway" data-sortable="false"
                                        data-align="center" data-formatter="feesOnlineTransactionLogParentGateway">
                                        {{ __('payment_gateway') }}</th>
                                    <th scope="col" data-field="payment_status" data-sortable="false" data-align="center"
                                        data-formatter="feesOnlineTransactionLogPaymentStatus">
                                        {{ __('payment_status') }}
                                    </th>
                                    <th scope="col" data-field="order_id" data-sortable="false" data-align="center"
                                        data-visible="false">{{ __('order_id') }} / {{ __('payment_intent_id') }}</th>
                                    <th scope="col" data-field="payment_id" data-sortable="false" data-align="center"
                                        data-visible="false">{{ __('payment_id') }}</th>
                                    <th scope="col" data-field="payment_signature" data-sortable="false"
                                        data-align="center" data-visible="false">{{ __('payment_signature') }}</th>

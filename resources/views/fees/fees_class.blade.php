                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-end mb-3 mt-3">
                            ...
                            <div class="col-md-2">
                                <label for="filter_medium_id" style="font-size: 0.89rem">
                                    {{ __('medium') }}
                                </label>
                        ...
                        <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-formatter="amountFormatter" data-field="base_amount"
                                        data-sortable="false" data-align="center">
                                        {{ __('base') }} {{ __('amount') }}</th>
                                    <th scope="col" data-formatter="amountFormatter" data-field="total_amount"
                                        data-sortable="false" data-align="center">
                            ...
                            <div class="row col-12">
                                ...
                                <div class="col-2 pl-0 text-center">
                                    <button type="button" class="btn btn-icon btn-inverse-danger remove-fees-type"
                                        title="Remove Fees Type" data-related='["fee choiceables"]'>
